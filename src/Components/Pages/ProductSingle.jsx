...
const ProductSingle = () => {
  ...
  useEffect(()=>{
    ...
    axios.get(`http://localhost:5080/products?slug=${slug}`).then(res => {
    setProducts(res.data[0]);

    })
    axios.get(`http://localhost:5080/catagory/${products.catagoryId}/products`).then(res => {
      setReleted(res.data);
              ...
              <div className="single-product-price">
                <div className="row">
                  <div className="col-xs-6">
                    {
                      products.regullar_price !==''?
                      <h3><del>{products.regullar_price} BDT</del><span>{products.sell_price} BDT</span></h3>
                      :
                      <h3><del>{products.regullar_price} BDT</del></h3>
                    }
                    
                  </div>
                  <div className="col-xs-6 text-right">
                    
                 <Rating rate={products.rating} />

                  </div>
                </div>
              </div>
              <div className="single-product-desc">
                <p>{products.short_des}</p>
              </div>
